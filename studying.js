const aloneStartBtn = document.querySelector(".aloneToDoBox .subjectTitle button");


let studyingPopupPage;

function studyingPopupPageEvent(){
    const startRestBtn = document.querySelector(".studyingPopupFrame .restOrExit .rest");
    const finishAloneStudyBtn = document.querySelector(".studyingPopupFrame .restOrExit .exit");
...
function openAloneStudyPage(){
    ...
    studyingPopupPage = window.open("./popup_studying.html", "popup_studying", option);
